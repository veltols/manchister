...
<div class="studyPageView">
	<div class="studyViewTitle">
		<div class="textTitle">
			<h1><?=lang("Sections", "AAR"); ?></h1>
			<p>
				Use this section to add pages or extra content to your study
			</p>
		</div>
		<div class="actionTitle">
			<a onclick="addNewIntroductryPage('section');" class="ationButtons"><?=lang("create_page", "AAR"); ?></a>
		</div>
	</div>
	...
	$qu_m_strategic_studies_pages_sel = "SELECT * FROM  `m_strategic_studies_pages` 
										WHERE ((`study_id` = $study_id) AND (`page_type` = 'section')) ORDER BY `order_no` ASC";
	...
	if(mysqli_num_rows($qu_m_strategic_studies_pages_EXE)){
		...
		<div class="viewBoxWithOpts">
			...
			<div class="viewBoxOpts">
				<a href="<?= $POINTER; ?>ext/strategies/self_studies_view/?study_id=<?= $study_id; ?>&view=3&page_id=<?=$page_id; ?>" title="Edit Page"><i class="fa-solid fa-edit"></i></a>
