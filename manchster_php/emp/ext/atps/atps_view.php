...
$qu_atps_list_sel = "SELECT `atps_list`.*, 
							...
							INNER JOIN `atps_list_status` ON `atps_list`.`atp_status_id` = `atps_list_status`.`atp_status_id` 
	...
	<div class="tabContainer">
		...
		<div class="tabBody">
			<div class="tabContent">
				<?php
					include('ext/atps/atp_view/apps.php');
				?>
			</div>
			<div class="tabContent">
				<?php
				include('ext/atps/atp_view/renewal.php');
				?>
			</div>
			<div class="tabContent">
				<?php
			...
			<div class="tabContent">
				<?php
				include('ext/atps/atp_view/accreditation.php');
				?>
			</div>
			<div class="tabContent">
				<?php
				include('ext/atps/atp_view/cancelation.php');
				?>
			</div>
			<div class="tabContent">
				<?php
				include('ext/atps/atp_view/learner_enrollment.php');
				?>
			</div>
			<div class="tabContent">
				<?php
				include('ext/atps/atp_view/logs.php');
				?>
			</div>
		</div>
	</div>
