...
//change form status form_status = approved @ atps_prog_register_req
$qu_atps_prog_register_req_updt = "UPDATE  `atps_prog_register_req` SET 
								`form_status` = 'approved'
								WHERE `atp_id` = $atp_id;";

if (!mysqli_query($KONN, $qu_atps_prog_register_req_updt)) {
	die("ERr-98792");
}
...
//check if to send to qualification or continue
...
//insert ATP log
if (InsertAtpLog("IQC Approved Registration request form", $atp_id, 'employees_list', $EMPLOYEE_ID, 'R&C')) {
