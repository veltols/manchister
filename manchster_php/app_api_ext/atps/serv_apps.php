...
if ($IS_LOGGED == true && $USER_ID != 0) {
	...
	if (mysqli_num_rows($qu_atps_sed_form_EXE)) {
		...
		/*
						array_push($IAM_ARRAY['data'], array(   "app_name" => lang("Prospective ATP Evidence against the ATPQS", "AAR"), 
																				"app_type" => '5', 
																				"submission_start" => 'NA', 
																				"submitted_date" => 'NA',
																				"app_status" => decryptData( $app_status ),
						...
						array_push($IAM_ARRAY['data'], array(   "app_name" => lang("Quality Improvement Plan (QIP)", "AAR"), 
																				"app_type" => '6', 
																				"submission_start" => 'NA', 
																				"submitted_date" => 'NA',
																				"app_status" => decryptData( $app_status ),
