...
/* Custom Colors */
:root { --primary : <?=$DARK_COLOR; ?>; }
:root { --secondary   : <?=$LIGHT_COLOR; ?>; }
:root { --on-primary : <?=$ONDARK_COLOR; ?>; }
:root { --on-secondary   : <?=$ONLIGHT_COLOR; ?>; }
	...
	<link href="<?=$POINTER; ?>../public/assets/styles/pc.css" rel="stylesheet" media="(min-width:1026px) and (max-width:3500px)">
	<!-- tablet CSS -->
	<link href="<?=$POINTER; ?>../public/assets/styles/tablet.css" rel="stylesheet" media="(min-width:700px) and (max-width:1025px)">
	<!-- mob CSS -->
	<link href="<?=$POINTER; ?>../public/assets/styles/mob.css" rel="stylesheet" media="(min-width:100px) and (max-width:699px)">
