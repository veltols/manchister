...
<div class="userLiner" style="background-color: <?= $LIGHT_COLOR; ?>;">
	...
	<div class="userOptions" style="background-color: <?= $DARK_COLOR; ?>;">
		<div class="userName" onclick="showUserOptions();" style="color: <?= $ONDARK_COLOR; ?>;">
			<img src="<?= $UPLOADS_DIRECTORY; ?><?= $EMPLOYEE_PICTURE; ?>" alt="<?= $EMPLOYEE_NAME; ?>"
				class="empLogoImg">
...
<aside id="mainAside" class="<?= $thsAsideClass; ?>">
	...
	<div class="asideMenu">
		...
		<a href="<?= $DIR_dashboard; ?>" class="mnuItem <?php if ($pageId == 100) {
			  echo 'mnuItemSelected';
		  } ?>">
			<i class="fa-solid fa-house-chimney"></i>
			<span><?= lang("Dashboard"); ?></span>
		</a>

		<a href="<?= $DIR_rpl; ?>" class="mnuItem <?php if ($pageId == 150) {
			  echo 'mnuItemSelected';
		  } ?>">
			<i class="fa-regular fa-folder"></i>
			<span><?= lang("RPL Requests"); ?></span>
		</a>

		<a href="<?= $DIR_qm_rpl; ?>" class="mnuItem <?php if ($pageId == 250) {
			  echo 'mnuItemSelected';
		  } ?>">
			<i class="fa-solid fa-briefcase"></i>
			<span><?= lang("Qualification_Manager"); ?></span>
		</a>
