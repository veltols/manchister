...
<script>
	...
	var activeChat = 0;
	var allCheckInterval;

	function startAllChatChecking() {
		allCheckInterval = setInterval(function () {
			loadChats();
		}, 7500);
	}
	...
	function bnidChatsData(data) {
		...
		if (activeChat != 0) {
			markChatItem(activeChat, sName, sInit, 0);
			checkActiveChatNewMessages();
		}
	}
	function loadChats() {
...
<div class="groupsContainer">
	...
	<div class="groupsManager">
		<!-- Groups Header START -->
		<div class="gmHeader">
			<span class="titler"><?= lang("My_Messages", "AAR"); ?></span>
	...
	<div class="groupsViewer">
		...
		<div class="tabHeader tabHeaderHidden">
			...
			<div class="tabHeaderItems">
				<div id="tabHeader-1" onclick="switchTab(1);" class="tabItem tabItemActive">
