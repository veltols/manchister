...
$is_submitted = 0;
$form_status = "";
$qu_atps_register_request_sel = "SELECT * FROM  `atps_register_request` WHERE `atp_id` = $atp_id";
$qu_atps_register_request_EXE = mysqli_query($KONN, $qu_atps_register_request_sel);
if (mysqli_num_rows($qu_atps_register_request_EXE)) {
	$atps_register_request_DATA = mysqli_fetch_assoc($qu_atps_register_request_EXE);
	$form_id = (int) $atps_register_request_DATA['form_id'];
	$atp_id = (int) $atps_register_request_DATA['atp_id'];
	$added_date = $atps_register_request_DATA['added_date'];
	$submitted_date = $atps_register_request_DATA['submitted_date'];
	$is_submitted = (int) $atps_register_request_DATA['is_submitted'];
	$form_status = $atps_register_request_DATA['form_status'];
}
