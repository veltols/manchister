...
<div class="userLiner" style="background-color: <?=$LIGHT_COLOR; ?>;">
	...
	<div id="logoCol" class="logoCol" style="background-color: <?=$LIGHT_COLOR; ?>;color: <?=$ONLIGHT_COLOR; ?>;">
		...
		<a href="<?=$DIR_dashboard; ?>" class="mainLogo">
			<img src="<?=$UPLOADS_DIRECTORY; ?>connect_icon.png" alt="" class="mainLogoImg">
		</a>
...
<aside id="mainAside" class="<?=$thsAsideClass; ?>">
	...
	<div class="asideMenu">
		...
		<a href="<?=$DIR_calendar; ?>" class="mnuItem <?php if($pageId==150) { echo 'mnuItemSelected'; } ?>">
		...
		<a href="<?=$POINTER.'questions/list/'; ?>" class="mnuItem <?php if($pageId==600) { echo 'mnuItemSelected'; } ?>">
			<i class="fa-solid fa-circle-question"></i>
			<span><?=lang("Questions_Bank", "AAR"); ?></span>
		</a>
