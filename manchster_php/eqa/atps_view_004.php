...
<div class="twoCols threeCols">
	...
	<div class="former">
		...
		<!-- START OF FORM PANEL -->
		<div class="formPanel">
			<h2 class="formPanelTitle"><?= lang('EQA-ATP Internal Report for Accreditation'); ?></h2>
		...
		<div class="formPanel">
			...
			<div class="mainStandards">
				...
				<div class="mainView">
					...
					<a class="fillBtn" onclick="showModal('generalComments');"><?= lang("View", "AAR"); ?></a>
				</div>

				<div class="mainView">
					<i class="fa-solid fa-people-roof"></i>
					<h1>Supporting Evidence</h1>
					<a class="fillBtn" onclick="showModal('SupportingEvidence');"><?= lang("View", "AAR"); ?></a>
				</div>

				<div class="mainView">
					<i class="fa-solid fa-user"></i>
					<h1>Action Plan</h1>
					<a class="fillBtn" onclick="showModal('ActionPlan');"><?= lang("View", "AAR"); ?></a>
				</div>
...
<?php
$thsModal = 'generalComments';
$thsModalTitle = lang("general_Comments", "AAR");
?>
		...
		<div class="modalBody">
			...
			<form class="modalForm row" id="edit<?= $thsModal; ?>Form" id-modal="<?= $thsModal; ?>"
				...
				<table border="1" style="width: 100%;">
					<tbody>
						<tr>
							<td>If accreditation is not recommended, indicate the date for the application to be
								reviewed
							</td>
							<td>
								<div class="formGroup formGroup-100">
...
<?php
$thsModal = 'SupportingEvidence';
$thsModalTitle = lang("Supporting_Evidence", "AAR");
?>
<div id="<?= $thsModal; ?>" class="modal">
	<div class="modalData">
		<div class="modalHeader">
		...
		<div class="modalBody">
			...
			<form class="modalForm row" id="edit<?= $thsModal; ?>Form" id-modal="<?= $thsModal; ?>"
				...
				<table border="1" style="width: 100%;">
					<thead>
						<tr>
							<th style="width:50%;">Management & Administrative Systems</th>
							<th>Criteria</th>
							<th>---</th>
						</tr>
					</thead>
					<tbody>
						<?php
						$qu_004_temp_sel = "SELECT * FROM  `004_temp` WHERE `record_type` = '1'";
						$qu_004_temp_EXE = mysqli_query($KONN, $qu_004_temp_sel);
						if (mysqli_num_rows($qu_004_temp_EXE)) {
							while ($s004_temp_REC = mysqli_fetch_assoc($qu_004_temp_EXE)) {
								$record_id = (int) $s004_temp_REC['record_id'];
								$record_data = $s004_temp_REC['record_data'];
								?>
				...
				<table border="1" style="width: 100%;">
					<thead>
						<tr>
							<th style="width:50%;">Physical & Staff Resources</th>
							<th>Criteria</th>
							<th>---</th>
						</tr>
					</thead>
					<tbody>
						<?php
						$qu_004_temp_sel = "SELECT * FROM  `004_temp` WHERE `record_type` = '2'";
						$qu_004_temp_EXE = mysqli_query($KONN, $qu_004_temp_sel);
						if (mysqli_num_rows($qu_004_temp_EXE)) {
							while ($s004_temp_REC = mysqli_fetch_assoc($qu_004_temp_EXE)) {
								$record_id = (int) $s004_temp_REC['record_id'];
				...
				<table border="1" style="width: 100%;">
					<thead>
						<tr>
							<th style="width:50%;">Assessment Strategy</th>
							<th>Criteria</th>
							<th>---</th>
						</tr>
					</thead>
					<tbody>
						<?php
						$qu_004_temp_sel = "SELECT * FROM  `004_temp` WHERE `record_type` = '3'";
						$qu_004_temp_EXE = mysqli_query($KONN, $qu_004_temp_sel);
						if (mysqli_num_rows($qu_004_temp_EXE)) {
							while ($s004_temp_REC = mysqli_fetch_assoc($qu_004_temp_EXE)) {
								$record_id = (int) $s004_temp_REC['record_id'];
				...
				<table border="1" style="width: 100%;">
					<thead>
						<tr>
							<th style="width:50%;">Quality assurance</th>
							<th>Criteria</th>
							<th>---</th>
						</tr>
					</thead>
					<tbody>
						<?php
						$qu_004_temp_sel = "SELECT * FROM  `004_temp` WHERE `record_type` = '4'";
						$qu_004_temp_EXE = mysqli_query($KONN, $qu_004_temp_sel);
						if (mysqli_num_rows($qu_004_temp_EXE)) {
							while ($s004_temp_REC = mysqli_fetch_assoc($qu_004_temp_EXE)) {
								$record_id = (int) $s004_temp_REC['record_id'];
...
<?php
$thsModal = 'ActionPlan';
$thsModalTitle = lang("Action plan for the training provider", "AAR");
?>
<div id="<?= $thsModal; ?>" class="modal">
	<div class="modalData">
		<div class="modalHeader">
...
$thsModalTitle = lang("Staff met during the training provider approval visit", "AAR");
?>
<div id="<?= $thsModal; ?>" class="modal">
	<div class="modalData">
		<div class="modalHeader">
