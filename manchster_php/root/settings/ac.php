...
$pageDataController = $POINTER . "get_ac_list";
$addNewController = $POINTER . 'add_ac_list';
$updateController = $POINTER . 'update_ac_list';
...
<div class="pageHeader">
	<div class="pageTitle">
		<h1><?= lang("Assets_Categories", "AAR"); ?></h1>
	</div>
	<div class="pageNav">
		<?php
	...
	<div class="table">
		<div class="tableHeader">
			<div class="tr">
				...
				<div class="th"><?= lang("category_alert_days"); ?></div>
	...
	async function bindData(data) {
		...
		for (i = 0; i < data.length; i++) {
			...
			var dt = '<div class="tr levelRow" id="dataRow-' + data[i]["category_id"] + '">' +
				'	<div class="td">' + data[i]["category_id"] + '</div>' +
				'	<div class="td category_name">' + data[i]["category_name"] + '</div>' +
				'	<div class="td category_alert_days">' + data[i]["category_alert_days"] + '</div>' +
				'	<div class="td">' +
				btns +
				'	</div>' +
				'</div>';
...
<div class="modal" id="viewModal">
	...
	<div class="modalBody">
		<div class="row pageForm" id="editForm">
			...
			<div class="col-1">
				<div class="formElement">
					<label><?= lang("category_alert_days", "AAR"); ?></label>
					<input type="text" class="inputer category_alert_days_at_edit" data-name="category_alert_days"
						data-den="" data-req="1" data-type="int">
				</div>
			</div>
			<!-- ELEMENT END -->
	...
	<div class="modalBody">
		<div class="row pageForm" id="AddNewForm">
			...
			<div class="col-1">
				<div class="formElement">
					<label><?= lang("category_alert_days", "AAR"); ?></label>
					<input type="text" class="inputer" data-name="category_alert_days" data-den="" data-req="1"
						data-type="int">
				</div>
			</div>
			<!-- ELEMENT END -->
