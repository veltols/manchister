...
$pageDataController = $POINTER . "get_tc_list";
$addNewController = $POINTER . 'add_tc_list';
$updateController = $POINTER . 'update_tc_list';
...
<div class="pageHeader">
	<div class="pageTitle">
		<h1><?= lang("Tickets_Categories_List", "AAR"); ?></h1>
	</div>
	<div class="pageNav">
		<?php
