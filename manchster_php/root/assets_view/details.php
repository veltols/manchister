...
<div class="tableContainer" id="appsListDtd">
	<div class="table">
		<div class="tableHeader">
			<div class="tr">
				<div class="th"><?= lang("Asset_Name"); ?></div>
				<div class="th"><?= lang("Description"); ?></div>
				<div class="th"><?= lang("SKU"); ?></div>
				<div class="th"><?= lang("serial_NO"); ?></div>
		...
		<div class="tableBody" id="appsListDt">
			...
			<div class="tr levelRow" id="levelRow-sss">
				<div class="td"><?= $QS_DATA['asset_name']; ?></div>
				<div class="td"><?= $QS_DATA['asset_description']; ?></div>
				<div class="td"><?= $QS_DATA['asset_sku']; ?></div>
				<div class="td"><?= $QS_DATA['asset_serial']; ?></div>
			</div>
...
<div class="tableContainer" id="appsListDtd">
	<div class="table">
		...
		<div class="tableBody" id="appsListDt">
			...
			<div class="tr levelRow" id="levelRow-sss">
				<div class="td"><?= $QS_DATA['added_date']; ?></div>
				<div class="td"><?= $QS_DATA['added_by']; ?></div>
				<div class="td"><?= $QS_DATA['assigned_date']; ?></div>
				<div class="td">
					<?php
					if ($assigned_to != 0) {
						?>
						<a href="<?= $POINTER; ?>users/view/?employee_id=<?= $assigned_to; ?>"
							style="color: blue;"><?= $assigned_to_name; ?></a>
						<?php
					} else {
						?>
						<?= $assigned_to_name; ?>
...
if ($status_id != 3) {
	...
	<div class="tableContainer" id="appsListDtd">
		<div class="table">
			<div class="tableHeader">
				<div class="tr">
					<div class="th"><?= lang("Update_asset_status"); ?></div>
				</div>
			</div>
			<div class="tableBody" id="appsListDt">
...
<?php
/*
if ($QS_DATA['asset_attachment'] != 'no-img.png') {
	?>
	<div class="tableContainer" id="appsListDtd">
		<div class="table">
			<div class="tableHeader">
				<div class="tr">
					<div class="th"><?= lang("asset_attachment"); ?></div>
				</div>
			</div>
			<div class="tableBody" id="appsListDt">
				...
				<div class="tr levelRow" id="levelRow-sss">
					<div class="td">
						...
						<a href="<?= $POINTER; ?>../uploads/<?= $QS_DATA['asset_attachment']; ?>" target="_blank"
