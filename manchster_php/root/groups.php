		...
		<div class="row pageForm" id="newFileForm">
			...
			<div class="col-2">
				<div class="formElement">
					...
					<input type="hidden" class="inputer group-id-service" data-name="group_id" data-den="0" data-req="1"
						data-type="hidden">
					<input type="text" class="inputer file_name_new" data-name="file_name" data-den="" data-req="1"
						data-type="text">
				</div>
			</div>
			<!-- ELEMENT END -->
			...
			<div class="col-2">
				<div class="formElement">
					...
					<input type="file" class="inputer uploaded_file_new" data-name="uploaded_file" data-den=""
						data-req="1" data-type="file">
				</div>
			</div>
			<!-- ELEMENT END -->
