                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-semibold text-slate-800">{{ $iv->employee->first_name ?? 'Unknown' }} {{ $iv->employee->last_name ?? '' }}</span>
                            </div>
                        </td>
            ...
            <div class="space-y-4">
                ...
                <div class="border-t pt-4 mt-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="answer_texts[]" rows="2" class="premium-input w-full px-4 py-3 text-sm"></textarea>
                    </div>
                    @endforeach
                </div>
                ...
                <div>
                    ...
                    <textarea name="interview_remarks" rows="3" class="premium-input w-full px-4 py-3 text-sm"></textarea>
                </div>
            </div>
