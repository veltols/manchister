                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-800 flex items-center gap-2">
                                    {{ $chatPartner->first_name ?? 'Unknown' }}
                                    {{ $chatPartner->last_name ?? '' }}
                                    <span class="text-[10px] text-slate-400 font-mono">#{{ $chatPartner->employee_no }}</span>
                                    <span class="text-[11px] font-bold text-brand bg-brand/5 px-2.5 py-0.5 rounded-full border border-brand/10">{{ $chatPartner->designation->designation_name ?? 'Employee' }}</span>
