...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in-up" x-data="{ 
        ...
        <form id="deleteForm" action="{{ route('hr.notifications.destroy') }}" method="POST" style="display: none;">
            @csrf
        ...
        <div class="space-y-4">
            ...
            @empty
                <div class="py-20 text-center bg-white rounded-3xl border border-slate-100 shadow-sm">
                    <div class="w-20 h-20 rounded-full bg-slate-50 flex items-center justify-center text-slate-200 mx-auto mb-6">
