...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-display font-bold text-slate-800">Committees & Groups</h2>
            <p class="text-sm text-slate-500 mt-1">{{ $groups->count() }} total groups</p>
        </div>
        <button onclick="openModal('createGroupModal')" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200">
            ...
            <div class="premium-card p-6 hover:shadow-xl transition-all duration-200 h-full flex flex-col justify-between group">
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h3 class="font-bold text-lg text-slate-800 group-hover:text-indigo-600 transition-colors">{{ $g->group_name }}</h3>
...
<div class="modal" id="createGroupModal">
    ...
    <div class="modal-content max-w-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-display font-bold text-slate-800">New Group / Committee</h2>
