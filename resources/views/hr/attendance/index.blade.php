...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <button onclick="openModal('addAttendanceModal')" class="inline-flex items-center gap-2 px-6 py-3 premium-button from-indigo-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200">
    ...
    <div class="modal-content max-w-lg p-6">
        ...
        <form action="{{ route('hr.attendance.store') }}" method="POST">
            ...
            <div class="flex justify-end gap-3 mt-6 pt-6 border-t border-slate-200">
                ...
                <button type="submit" class="px-6 py-3 premium-button from-indigo-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200">Save Entry</button>
            </div>
        </form>
    </div>
</div>
