    ...
    <form method="GET" action="{{ route('admin.dashboard') }}" class="flex items-center">
        <div class="relative group">
            ...
            <select name="mode" onchange="this.form.submit()"
                class="appearance-none pl-10 pr-10 py-2.5 text-sm font-semibold rounded-xl bg-white border border-slate-200 text-slate-700 shadow-sm focus:ring-2 focus:ring-indigo-500 hover:border-indigo-300 transition-all cursor-pointer">
...
@section('content')
    ...
    <div x-data="{ activeTab: 'tickets' }" class="space-y-8">

        <!-- Tab Navigation -->
        <div class="flex flex-wrap items-center gap-2 p-1 bg-slate-100/50 rounded-2xl w-fit">
            <button @click="activeTab = 'tickets'"
                class="px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-3 transition-all duration-200"
        ...
        <div x-show="activeTab === 'tickets'" x-transition:enter="transition ease-out duration-300 transform"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <!-- Total (Hero) -->
                <div
                    class="lg:col-span-4 bg-gradient-brand p-8 rounded-2xl shadow-xl shadow-brand/20 text-white relative group overflow-hidden transition-all hover:-translate-y-1">
                    <div
                        class="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-white/10 to-transparent pointer-events-none">
                    </div>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div class="flex items-center gap-6">
                            <div
                                class="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-3xl shadow-inner border border-white/10">
                ...
                <!-- Open -->
                <div
                    class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_-3px_rgba(239,68,68,0.1)] border border-slate-100 relative group overflow-hidden transition-all hover:-translate-y-1 hover:shadow-lg">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div
                            class="w-12 h-12 rounded-2xl bg-red-50 text-red-500 flex items-center justify-center text-xl shadow-inner">
                            <i class="fa-solid fa-envelope-open"></i>
                        </div>
                    </div>
                    <div class="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mt-2">
                        <div class="bg-red-500 h-full rounded-full"
                            style="width: {{ $totalTickets > 0 ? ($totalOpen / $totalTickets) * 100 : 0 }}%"></div>
                    </div>
                </div>

                <!-- In Progress -->
                <div
                    class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_-3px_rgba(59,130,246,0.1)] border border-slate-100 relative group overflow-hidden transition-all hover:-translate-y-1 hover:shadow-lg">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                    ...
                    <div class="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mt-2">
                        <div class="bg-blue-500 h-full rounded-full"
                            style="width: {{ $totalTickets > 0 ? ($totalProgress / $totalTickets) * 100 : 0 }}%"></div>
                    </div>
                </div>

                <!-- Resolved -->
                <div
                    class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_-3px_rgba(34,197,94,0.1)] border border-slate-100 relative group overflow-hidden transition-all hover:-translate-y-1 hover:shadow-lg">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                    ...
                    <div class="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mt-2">
                        <div class="bg-green-500 h-full rounded-full"
                            style="width: {{ $totalTickets > 0 ? ($totalResolved / $totalTickets) * 100 : 0 }}%"></div>
                    </div>
                </div>

                <!-- Unassigned -->
                <div
                    class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_-3px_rgba(249,115,22,0.1)] border border-slate-100 relative group overflow-hidden transition-all hover:-translate-y-1 hover:shadow-lg">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                    ...
                    <div class="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mt-2">
                        <div class="bg-orange-500 h-full rounded-full"
                            style="width: {{ $totalTickets > 0 ? ($totalUnassigned / $totalTickets) * 100 : 0 }}%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                ...
                <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col">
                    <h3 class="font-display font-bold text-lg text-slate-800 mb-8 border-b border-slate-100 pb-4">Tickets by
                        Department</h3>
            ...
            <!-- RECENT TICKETS -->
            <div
                class="bg-white rounded-[2rem] shadow-lg shadow-slate-200/50 border border-slate-100 overflow-hidden mb-12">
                <div
                    class="p-8 border-b border-slate-100 flex justify-between items-center bg-gradient-to-r from-white to-slate-50">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center shadow-sm">
                    ...
                    <a href="{{ route('admin.tickets.index') }}"
                        class="group flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-brand text-white text-sm font-bold shadow-lg shadow-brand/20 hover:shadow-brand/40 hover:-translate-y-0.5 transition-all duration-300 border border-white/10">
                        <span>View All</span>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-slate-50/50 border-b border-slate-100">
                                ...
                                <th class="px-8 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Requested By
                                </th>
                                <th class="px-8 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Date</th>
                                <th class="px-8 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider text-center">
                                    Status</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-100">
                            @forelse($recentTickets as $ticket)
                                <tr class="group hover:bg-slate-50 transition-colors cursor-default">
                                    <td class="px-8 py-5">
                                        <span
                                            class="font-mono font-semibold text-slate-700 bg-slate-100 px-2 py-1 rounded text-xs select-all">#{{ $ticket->ticket_ref ?? $ticket->ticket_id }}</span>
                                    </td>
                                    <td class="px-8 py-5">
                                        <span
                                            class="font-semibold text-slate-700 group-hover:text-indigo-600 transition-colors">{{ $ticket->ticket_subject }}</span>
                                    </td>
                                    <td class="px-8 py-5">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 text-white flex items-center justify-center text-xs font-bold shadow-sm ring-2 ring-white">
                                                {{ substr($ticket->added_employee, 0, 1) }}
                                            </div>
                                            <span
                                                class="text-sm font-medium text-slate-600">{{ $ticket->added_employee }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-8 py-5 text-center">
                                        @if($ticket->status_id == 1)
                                            <span
                                                class="px-3 py-1.5 text-xs font-bold text-red-700 bg-red-50 border border-red-100 rounded-full shadow-sm">Open</span>
                                        @elseif($ticket->status_id == 2)
                                            <span
                                                class="px-3 py-1.5 text-xs font-bold text-blue-700 bg-blue-50 border border-blue-100 rounded-full shadow-sm">In
                                                Progress</span>
                                        @elseif($ticket->status_id == 3)
                                            <span
                                                class="px-3 py-1.5 text-xs font-bold text-green-700 bg-green-50 border border-green-100 rounded-full shadow-sm">Resolved</span>
                                        @else
                                            <span
                                                class="px-3 py-1.5 text-xs font-bold text-slate-600 bg-slate-100 border border-slate-200 rounded-full shadow-sm">Unknown</span>
                                        @endif
                                    </td>
                                </tr>
                            @empty
        ...
        <div x-show="activeTab === 'assets'" x-transition:enter="transition ease-out duration-300 transform"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <!-- Total -->
                <div
                    class="bg-gradient-brand p-6 rounded-2xl shadow-lg shadow-brand/20 text-white relative group overflow-hidden transition-all hover:-translate-y-1">
                    ...
                    <div
                        class="mt-4 flex items-center gap-2 text-xs font-medium text-cyan-50 bg-white/10 w-fit px-3 py-1 rounded-full backdrop-blur-sm">
                ...
                <!-- In Stock -->
                <div
                    class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 relative group overflow-hidden transition-all hover:-translate-y-1 hover:shadow-lg">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                        ...
                        <div
                            class="w-12 h-12 rounded-2xl bg-teal-50 text-teal-600 flex items-center justify-center text-xl">
                ...
                <div
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div
                            class="w-12 h-12 rounded-2xl bg-cyan-50 text-cyan-600 flex items-center justify-center text-xl">
                ...
                <div
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div
                            class="w-12 h-12 rounded-2xl bg-slate-100 text-slate-500 flex items-center justify-center text-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
                ...
                <!-- Assets by Dept -->
                <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col">
                    <h3 class="font-display font-bold text-lg text-slate-800 mb-8 border-b border-slate-100 pb-4">Assets by
                        Department</h3>
