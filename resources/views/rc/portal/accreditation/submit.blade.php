...
@php $pageTitle = 'Submit Application'; @endphp
...
@section('acc-content')
    <div class="max-w-3xl mx-auto">
        <div class="text-center mb-10">
            ...
            <p class="text-slate-500 mt-2">Please review the terms and conditions before submitting your accreditation
                request.</p>
        </div>
        ...
        <div class="premium-card p-8 mb-8"
            ...
            <div class="mt-10 pt-8 border-t border-slate-100">
                <form id="submissionForm" method="POST" action="{{ route('rc.portal.accreditation.submit.process') }}">
                    @csrf
    ...
    <script>
        function confirmSubmission() {
            ...
            Swal.fire({
                ...
                text: 'Are you sure you want to submit your application? This action cannot be undone.',
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        title: 'Processing...',
                        text: 'We are submitting your application.',
