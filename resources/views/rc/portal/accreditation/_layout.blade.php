{{--
Shared accreditation sub-form layout
Usage: @include('rc.portal.accreditation._layout', ['activeTab' => 'initial_form', 'title' => '...'])
--}}
@extends('layouts.app')

@section('title', $pageTitle ?? 'Accreditation')
@section('subtitle', 'Initial Request for Registration')
...
@section('content')
    <div class="animate-fade-in-up"
        ...
        <div class="flex items-center justify-between px-8 py-6"
            ...
            <div class="flex items-center gap-5 relative z-10">
                ...
                <div>
                    <h2 class="text-white font-black text-xl tracking-tight leading-none">
                        {{ $pageTitle ?? 'Initial Request for Registration' }}
                    </h2>
            ...
            @if(isset($saveTarget))
                <button form="mainForm" type="submit" class="btn-save relative z-10"
                    style="background:rgba(255,255,255,0.1); border:1px solid rgba(255,255,256,0.2); backdrop-filter: blur(10px); box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
                    <i class="fa-solid fa-floppy-disk text-xs opacity-70"></i>
        ...
        <div class="acc-tab-nav">
            @php
                $tabs = [
                    ['route' => 'rc.portal.accreditation.initial_form', 'icon' => 'fa-file-pen', 'label' => 'Initial Form'],
                    ['route' => 'rc.portal.accreditation.qualifications', 'icon' => 'fa-graduation-cap', 'label' => 'Qualifications'],
                    ['route' => 'rc.portal.accreditation.faculty', 'icon' => 'fa-users', 'label' => 'Faculty Details'],
                    ['route' => 'rc.portal.accreditation.learners', 'icon' => 'fa-chart-bar', 'label' => 'Learners Statistics'],
                    ['route' => 'rc.portal.accreditation.electronic_systems', 'icon' => 'fa-laptop', 'label' => 'Electronic Systems'],
                    ['route' => 'rc.portal.accreditation.attachments', 'icon' => 'fa-paperclip', 'label' => 'Attachments'],
                    ['route' => 'rc.portal.accreditation.submit', 'icon' => 'fa-rocket', 'label' => 'Submit Application'],
                ];
            @endphp
            @foreach($tabs as $tab)
