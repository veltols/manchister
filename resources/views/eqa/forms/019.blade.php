...
@section('title', 'Form 019')
@section('subtitle', 'Learner Interview Questions')
...
@section('content')
    <div class="max-w-5xl mx-auto space-y-8 animate-fade-in-up">
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-0.5">Learner Interview Protocol
                    </p>
                </div>
            </div>
        ...
        <form action="{{ route('eqa.forms.store', ['form_id' => '019', 'atp_id' => $atp->atp_id]) }}" method="POST"
            class="space-y-8">
            @csrf
            ...
            <div class="premium-card p-6">
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Learner
                        Name</label>
                    <div class="relative">
                        <i class="fa-solid fa-user absolute left-4 top-1/2 -translate-y-1/2 text-slate-300"></i>
                        <input type="text" name="learner_name"
                            class="premium-input w-full pl-11 focus:border-brand focus:ring-brand/5"
                            value="{{ $formData->learner_name ?? '' }}" placeholder="Enter name of learner interviewed...">
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3 text-slate-400">
                    <i class="fa-solid fa-clipboard-question text-brand"></i>
